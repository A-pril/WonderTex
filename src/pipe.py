...
class StableDiffusionControlNetPipeline(
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            untruncated_ids = self.tokenizer(prompt, padding="longest", return_tensors="pt").input_ids #[1, 13]
    ...
    def prepare_latents(self, batch_size, num_channels_latents, height, width, dtype, device, generator, timesteps, latents=None):
        ...
        if latents is None:
            ...
            # scale the initial noise by the standard deviation required by the scheduler
            noise = randn_tensor(shape, generator=generator, device=device, dtype=dtype) * self.scheduler.init_noise_sigma
